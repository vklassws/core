...
// DEFAULT EXPORT
import _Core, { CoreExtenders } from './core'
...
interface Core extends _Core, Extenders_Class_Intersection {

}

const Core = _Core as
{ new(...args: ConstructorParameters<typeof _Core>): Core }
& ExcludeConstructor<typeof _Core> & ExcludeConstructor<Extenders_Constructor_Intersection>
